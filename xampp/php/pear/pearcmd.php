...
if ('D:\Pidh\UMS\Praktikum-Web\xampp\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('D:\Pidh\UMS\Praktikum-Web\xampp\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
